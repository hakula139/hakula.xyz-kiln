...
![PLAY OPTION](assets/left/play.webp)
...
::: callout {type=tip title="To IIDX 玩家"}
...
<!-- TODO: style shortcode not yet supported: {{< style "table { min-width: 30rem; }" >}} -->
...
::: callout {type=note title="对判定的影响"}
...
![SYSTEM OPTION](assets/left/sys.webp)
...
![KEY CONFIG](assets/key-config.webp)
...
<!-- TODO: style shortcode not yet supported: {{< style "table td { min-width: 8rem; }" >}} -->
...
::: callout {type=info title="START / SELECT 键使用说明"}
...
<!-- TODO: style shortcode not yet supported: {{< style "table td { min-width: 3rem; }" >}} -->
...
![SCORE DETAIL](assets/left/score.webp)
...
![TAG EDITOR - 歌曲](assets/left/tag-song.webp)
...
![TAG EDITOR - 文件夹](assets/left/tag-folder.webp)
...
![TAG EDITOR - Course](assets/left/tag-course.webp)
...
![PLAYER INFO](assets/left/info.webp)
...
![EXTRA MODE](assets/extra-mode.webp)
