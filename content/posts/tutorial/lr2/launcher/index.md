...
![注册提示](assets/register-prompt.webp)

![注册界面](assets/register.webp)
...
![注册成功](assets/register-success.webp)

## MAIN

进入启动器界面。未转区的玩家会遇到乱码，我们点击左上角的 Language 选项将语言切换成 English。

![切换语言](assets/switch-language.webp)
