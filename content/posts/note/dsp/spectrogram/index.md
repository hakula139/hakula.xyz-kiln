...
![one - 语谱图（10 ms + 汉明窗）](assets/one/spec-domain-10ms-hamming.webp)
...
![two - 语谱图（10 ms + 汉明窗）](assets/two/spec-domain-10ms-hamming.webp)
...
![six - 语谱图（10 ms + 汉明窗）](assets/six/spec-domain-10ms-hamming.webp)

![six - 语谱图（15 ms + 汉明窗）](assets/six/spec-domain-15ms-hamming.webp)
