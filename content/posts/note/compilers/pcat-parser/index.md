...
```cpp {title="src/utils/logger.cpp"}
void Logger::Log(
...
```cpp {title="pcat_lexical_analyzer/src/lexer.hpp"}
enum Tokens {
  T_EOF = 0,
  T_WS,
  T_NEWLINE,
