...
featured_image = "/images/article-covers/90743556.webp"
tags = [
    "PRML",
    "机器学习",
    "KNN",
...
![实验 1 - 训练集](assets/1-train.webp){width=500}

![实验 1 - 测试集](assets/1-test.webp){width=500}
...
![实验 2 - 训练集](assets/2-train.webp){width=500}

![实验 2 - 测试集](assets/2-test.webp){width=500}
...
![实验 3 - 训练集](assets/3-train.webp){width=500}

![实验 3 - 测试集](assets/3-test.webp){width=500}
